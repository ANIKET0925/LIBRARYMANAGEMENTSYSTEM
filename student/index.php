...
<html lang="en">
    ...
    <head>
        ...
        <title>TCSC LIBRARY DEPARTMENT</title>
    ...
    <body>
        <div class="navbar navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container">
                    <img id="shop" src="head.png" alt="">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="index.php">TCSC LIBRARY DEPARTMENT </a>
...
<div class="footer">
            <div class="container">
                <b class="copyright">&copy; GROUP 15 Library Management System </b>.
            </div>
        </div>
